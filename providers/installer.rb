...
action :configure do
  ...
  template ob_cfg_path do
    ...
    variables(
        ...
        AUTHENTICATION_SSL_CERT: ob_config['server']['config']['AUTHENTICATION']['SSL_CERT'],
        AUTHENTICATION_SSL_KEY: ob_config['server']['config']['AUTHENTICATION']['SSL_KEY'],
        AUTHENTICATION_USERNAME: ob_config['server']['config']['AUTHENTICATION']['USERNAME'],
        AUTHENTICATION_PASSWORD: ob_config['server']['config']['AUTHENTICATION']['PASSWORD'],
